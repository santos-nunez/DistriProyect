...
//            HiloRMI h3 = new HiloRMI("", "", remote, socket);
...
//                }
//                if(tipoSolicitud.equalsIgnoreCase("VALIDAR")){
//                    String response = "PETICION DE " + tipoSolicitud ;
//                    socket.send(response.getBytes(ZMQ.CHARSET), 0);
//                }
//                if (tipoSolicitud.equalsIgnoreCase("SOLICITAR") && !h3.isAlive()) {
//                    h3 = new HiloRMI("solicitar", mensaje, remote, socket);
//                    h3.start();
//                } else if (tipoSolicitud.equals("RENOVAR") && !h.isAlive()) {
